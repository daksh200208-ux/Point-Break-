...
EXPLICIT_ACTION_MAP: Dict[str, RiskLevel] = {
    ...
    "track_flight": RiskLevel.R0_READ_ONLY,
    "search_hotels": RiskLevel.R0_READ_ONLY,
    "check_hotel_reservation": RiskLevel.R0_READ_ONLY,
    "search_local_services": RiskLevel.R0_READ_ONLY,
    ...
    "select_flight": RiskLevel.R1_LOW_IMPACT,
    "select_hotel": RiskLevel.R1_LOW_IMPACT,
    "create_support_ticket": RiskLevel.R1_LOW_IMPACT,
    "draft_complaint": RiskLevel.R1_LOW_IMPACT,
    ...
    "schedule_service_appointment": RiskLevel.R2_EXTERNAL_COMMS,
